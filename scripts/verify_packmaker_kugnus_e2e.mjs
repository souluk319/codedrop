...
const MAX_WAIT_MS = Number(process.env.PACKMAKER_KUGNUS_E2E_TIMEOUT_MS || 600_000);
...
const child = spawn(process.execPath, ['server.js'], {
    env: {
        ...
        PORT: String(port),
        REQUEST_LOGS: '0',
        PACK_MAKER_TIMEOUT_MS: process.env.PACK_MAKER_TIMEOUT_MS || '600000',
        PACK_MAKER_BATCH_TIMEOUT_MS: process.env.PACK_MAKER_BATCH_TIMEOUT_MS || '180000',
        PACKMAKER_KUGNUS_E2E_TIMEOUT_MS: process.env.PACKMAKER_KUGNUS_E2E_TIMEOUT_MS || '600000'
    },
