...
assert(index.includes('--music-island-width: min(380px, calc(100vw - 120px));'), 'music island should expand left without covering the command input');
assert(index.includes('--music-island-expanded-width: min(640px, max(var(--music-island-width), calc(50vw - 264px)));'), 'music island detail view should expand left without crossing into the command input lane');
